...
- [x] **Personal-vs-CPI chart renders after two months of entries (wow moment)**
...
- [x] **Log a monthly price per item**
...
- [x] **Per-item price history table**
...
- [x] **Design polish — first-run empty state**
